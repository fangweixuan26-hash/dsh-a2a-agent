 ...
 *   - message/send   (LLM-powered reply, deterministic echo fallback)
 *   - tasks/get
 *   - tasks/cancel
 *
 * The plugin reuses the host `webServer` service, so it adds routes to the
 * harness's existing HTTP carrier instead of binding its own port.
 */
